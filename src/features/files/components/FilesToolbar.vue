  ...
  <header class="border-b border-border bg-surface px-4 py-3">
    <div class="flex flex-col gap-2">
      <div class="flex flex-col gap-2 lg:flex-row lg:items-center">
        <div class="flex min-w-0 flex-1 items-center gap-2 rounded-md border border-input bg-surface-2 px-2.5 text-[12px]">
      ...
      <nav class="flex min-w-0 flex-wrap items-center gap-1 text-[13px]" aria-label="Breadcrumb">
